  ...
  return (
    <Fragment>
      <div className='mt-14 flex flex-col items-center justify-center'>
        <h1 className='text-3xl font-bold text-center border-b-4 border-b-primary w-max'>Top Picks</h1>
        <TopPickCarousel slides={slides}/>
        <h1 className='text-3xl font-bold mt-14 text-center border-b-4 border-b-primary w-max'>Deals of the Day</h1>
        <DealsofDay/>
      </div>
    </Fragment>
  )
